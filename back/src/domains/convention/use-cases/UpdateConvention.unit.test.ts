...
describe("Update Convention", () => {
    ...
    describe("when user is not allowed", () => {
      ...
      describe("with convention jwt payload", () => {
        ...
        it.each([
          ...
          "agency-admin",
          "establishment-tutor",
        ] satisfies Role[])("throws forbiden if user role is not allowed", async (role) => {
          uow.conventionRepository.setConventions([convention]);
  ...
  describe("Right path", () => {
    ...
    describe("when connected user is a signatory", () => {
      ...
      it.each(
        signatoryCases,
      )("updates, clears signatures and re-signs without changing email when $role", async ({
        user,
        storedConvention,
        withSignature,
      }) => {
      ...
      it.each(
        signatoryCases,
      )("updates, clears signatures and re-signs when email changes when $role", async ({
        user,
        storedConvention,
        withChangedEmail,
        withSignature,
