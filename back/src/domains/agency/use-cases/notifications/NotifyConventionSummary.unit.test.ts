...
import {
  makeNotifyConventionSummary,
  type NotifyConventionSummary,
} from "./NotifyConventionSummary";
...
describe("NotifyConventionSummary", () => {
  ...
  let useCase: NotifyConventionSummary;
  ...
  beforeEach(() => {
    ...
    useCase = makeNotifyConventionSummary({
