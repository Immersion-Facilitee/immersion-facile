...
export type NotifyConventionSummary = ReturnType<
  typeof makeNotifyConventionSummary
>;
export const makeNotifyConventionSummary = useCaseBuilder(
  "NotifyConventionSummary",
)
  .withDeps<{
